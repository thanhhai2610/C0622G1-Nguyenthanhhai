...
import utils.exception.check.ValidateCustomer.ValidateAddress;
import utils.exception.check.ValidateCustomer.ValidateGuestType;
...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public String infoGuestType() {
        ValidateGuestType validateGuestType = new ValidateGuestType();
        String guestType;
        while (true) {
            guestType = inputString("(Diamond,Platinum , Gold, Silver, Member)");
            if (guestType.equals("")) {
                continue;
            }
            if (validateGuestType.validate(guestType)) {
                return guestType;
            } else {
